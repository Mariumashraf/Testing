...
import com.crmpro.pages.CreateNewContactPage;
	...
	CreateNewContactPage createNewContactPage;
	  ...
	  @Parameters({"browser"})
		...
		public void login(String browser, Method method) throws ATUTestRecorderException, IOException {
			...
			createNewContactPage = contactPage.clickOnCreateNC();
			//contactPage.clickOnCreateNC();
	  ...
	  public void addContact(String fName, String lName, String companyName, String departmentName) throws IOException {
		  createNewContactPage.addNewContact(fName, lName, companyName, departmentName);
		...
		public Object[][] testData() throws IOException {
			Object data[][]= TestUtils.getDataFromExcel("Contact");
			return data;
